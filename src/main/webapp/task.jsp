						...
						<div class="white-box">
							<div class="table-responsive">
								<table class="table" id="example">
									...
									<tbody>
										<c:forEach items="${listTask}" var="data">
											<tr>
												<td>${data.id }</td>
												<td>${data.name }</td>
												<td>${data.idJob.name }</td>
												<td>${data.idUser.fullname }</td>
												<td>${data.startDate }</td>
												<td>${data.endDate }</td>
												<td>${data.idStatus.name }</td>
												<td>
												    <a href="/helloservlet/task-update?id=${data.id}" class="btn btn-sm btn-primary">Sửa</a>
													<a href="#" id-task="${data.id}" class="btn btn-sm btn-danger btn-xoa">Xóa</a> 
