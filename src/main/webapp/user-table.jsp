									...
									<tbody>
										<c:forEach items="${listUser}" var="data">
											<tr>
												...
												<td>${data.lastname}</td>
												<td>${data.email}</td>
												<td>${data.idRole.name}</td>
												<td>
												    <a href="/helloservlet/user-update?id=${data.id}" class="btn btn-sm btn-primary">Sửa</a>
													<a href="#" userId="${data.id}" class="btn btn-sm btn-danger btn-xoa">Xóa</a>
													<a href="/helloservlet/user-details?id=${data.id}" class="btn btn-sm btn-info">Xem</a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
