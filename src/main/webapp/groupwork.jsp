                                ...
                                <table class="table" id="example">
                                    ...
                                    <c:forEach var="data" items="${listJob}">
                                        <tr>
                                            ...
                                            <td>${data.endDate}</td>
                                            <td>
                                               <a href="/helloservlet/groupword-update?id=${data.id}" class="btn btn-sm btn-primary">Sửa</a>
                                                <a href="#" id-job=${data.id} class="btn btn-sm btn-danger btn-xoa">Xóa</a>
                                                <a href="/helloservlet/groupword-details?id=${data.id}" class="btn btn-sm btn-info">Xem</a>
                                            </td>
                                        </tr>
                                     </c:forEach>
